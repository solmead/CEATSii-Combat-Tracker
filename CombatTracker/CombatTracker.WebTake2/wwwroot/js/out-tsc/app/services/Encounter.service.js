...
var EncounterService = /** @class */ (function () {
    ...
    Object.defineProperty(EncounterService.prototype, "selectedActor", {
        ...
        set: function (actor) {
            var act = this.actions.find(function (item) { return item.whoIsActing_ID === actor.id && item.actionType == EnumDefinitions.ActionTypeEnum.Current; });
    ...
    EncounterService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [GamesRepository,
            ActorsRepository,
            ActionsRepository,
            EncounterRepository,
            SettingsService])
