Partial Class SizeRating
    Inherits IEntity(Of SizeRating)
    Public Overrides Function ToString() As String
        Return Name
    End Function

    Public Shared Function LoadByName(ByVal DB As RMSSDataDataContext, ByVal Name As String) As SizeRating
        Return (From SC In DB.SizeRatings Where SC.Name = Name Select SC).FirstOrDefault
    End Function
